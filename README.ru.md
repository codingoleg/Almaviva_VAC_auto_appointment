...
Скрипт позволяет искать свободные окна в визовом центре Италии и автоматически 
регистрироваться на подачу визы через сайт https://ru.almaviva-visa.services. \
